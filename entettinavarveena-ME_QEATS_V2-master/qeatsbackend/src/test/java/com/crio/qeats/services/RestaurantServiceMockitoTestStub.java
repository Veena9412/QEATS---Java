...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    //  defined below.
    restaurantList1 = Arrays.asList(
        new Restaurant("11", "Restaurant11", "CityA", "url1",
            20.0, 30.2, "10:00", "22:00", Arrays.asList("South Indian")),
        new Restaurant("14", "Restaurant14", "CityB", "url2",
            20.0, 30.2, "10:00", "22:00", Arrays.asList("Tamil"))
    );

    restaurantList2 = Arrays.asList(
        new Restaurant("12", "Restaurant12", "CityC", "url3",
            21.0, 31.1, "10:00", "22:00", Arrays.asList("North Indian")),
        new Restaurant("14", "Restaurant14", "CityB", "url2",
            21.0, 31.1, "10:00", "22:00", Arrays.asList("Tamil"))
    );
    ...
    allRestaurantsCloseByOffPeakHours = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.2),
                                          LocalTime.of(3, 0));
    allRestaurantsCloseByPeakHours = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(21.0, 31.1),
                                             LocalTime.of(19, 0));
